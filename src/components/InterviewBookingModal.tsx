    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-sm animate-in fade-in duration-150">
      <div className="bg-slate-900 border border-slate-700 w-full max-w-xl rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[85vh]">
                  ...
                  <button
                    ...
                    className={`w-full text-left p-4 rounded-2xl border transition-all duration-200 flex items-center justify-between ${
                      isFull
                        ...
                        : isSelected
                        ? "bg-blue-600/20 border-2 border-blue-400 ring-2 ring-blue-500/40 shadow-xl shadow-blue-500/20 scale-[1.02]"
                        : "bg-slate-950/60 border-slate-800 hover:border-slate-600 hover:bg-slate-800/50 hover:scale-[1.01] active:scale-[0.99] hover:shadow-md"
                    }`}
                  >
                    ...
                    <div>
                      {isFull ? (
                        ...
                        <div className="w-6 h-6 rounded-full bg-blue-500 text-white flex items-center justify-center shadow-md shadow-blue-400/50 ring-2 ring-blue-300">
                          <CheckCircle2 className="w-4 h-4" />
                        </div>
                      ) : (
                        <span className="text-[10px] bg-slate-800 text-slate-400 px-2.5 py-1 rounded-full border border-slate-700 font-medium">
                          Available
                        </span>
                      )}
                    </div>
        ...
        <div className="px-6 py-4 border-t border-slate-800 bg-slate-950/60 flex items-center justify-end space-x-3">
          <button
            onClick={onClose}
            className="px-4 py-2 rounded-xl text-xs font-semibold text-slate-400 hover:text-white hover:bg-slate-800 border border-transparent hover:border-slate-700 hover:scale-105 active:scale-95 transition-all"
          >
            Cancel
          </button>
          <button
            ...
            className="px-5 py-2.5 rounded-xl text-xs font-bold text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:shadow-xl hover:shadow-blue-500/30 hover:scale-105 active:scale-95 border border-blue-400/40 ring-1 ring-blue-400/30 hover:ring-2 hover:ring-blue-400/60 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
          >

        ...
        <div className="flex flex-col sm:flex-row items-center gap-3">
          ...
          <div className="relative flex-1 w-full">
            ...
            <input
              ...
              className="w-full bg-slate-950 border border-slate-700/80 rounded-2xl pl-10 pr-4 py-2.5 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-500/30 transition-all"
            />
          </div>

          {/* Hiring Only Toggle */}
          <label
            className={`flex items-center space-x-2.5 text-xs font-semibold cursor-pointer select-none px-4 py-2.5 rounded-2xl shrink-0 transition-all duration-200 hover:scale-105 active:scale-95 border ${
              hiringOnly
                ? "bg-emerald-500/15 text-emerald-300 border-emerald-500/60 ring-2 ring-emerald-500/25 shadow-md shadow-emerald-500/15"
                : "bg-slate-950 text-slate-300 border-slate-700/80 hover:border-slate-600 hover:shadow-sm"
            }`}
          >
            <input
              type="checkbox"
          ...
          {CATEGORIES.map((cat) => {
            ...
            return (
              <button
                ...
                className={`text-xs font-semibold px-4 py-2 rounded-xl whitespace-nowrap transition-all duration-200 border ${
                  isSelected
                    ? "bg-blue-600 text-white border-blue-400 ring-2 ring-blue-400/50 shadow-lg shadow-blue-500/30 scale-105"
                    : "bg-slate-950 text-slate-400 border-slate-800/90 hover:text-white hover:border-slate-700 hover:bg-slate-900/60 hover:scale-105 active:scale-95"
                }`}
              >
                {cat.label}
              </button>
      ...
      {loading ? (
        ...
        <div className="text-center py-16 bg-slate-900/40 rounded-3xl border border-slate-800 p-8 space-y-3">
          ...
          <button
            ...
            className="inline-flex items-center px-4 py-2 rounded-xl bg-blue-600/20 text-blue-400 border border-blue-500/30 hover:bg-blue-600/30 hover:border-blue-400 hover:scale-105 active:scale-95 text-xs font-bold transition-all mt-2"
          >
            Reset all filters
          </button>
        </div>
